	...
	Pour le moment, grace à l'application on peut:
		...
		> rechercher un eleve à partir de son matricule
		> rechercher un enseignant à partir de son matricule
	...
	3- Avoir créeé la base de données "bd_systeme_scolaire"

		
								LES ETAPES POUR VOIR LA DOCUMENTATION DE L'APPLICATION
								
		> Ouvrir le dossier "Livrable 5"
	...
	Pour executer l'application, voici les etapes à suivre :
		...
		1- ouvrir le dossier "Livrable 5"
		...
		2- Se positioner dans le dossier "Livrable 5" (commande : 'cd [chemin]/[dossier cible]')
		3- Quand vous etes dans le dossier "Livrable 5", taper la commande 'java -jar Systeme.jar'
